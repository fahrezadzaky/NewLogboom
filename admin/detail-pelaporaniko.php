...
if (isset($_POST['submit'])) {
  if (updatePelaporaniko($_POST) > 0) {
    echo "<script>alert('Update data successfully!'); window.location='data-pelaporaniko.php';</script>";
  } else {
    echo "<script>alert('Data update failed or you did not make any changes!'); window.location='data-pelaporaniko.php';</script>";
  }
}

$id = $_GET['id'];
$data = query("SELECT * FROM pelaporaniko WHERE id = '$id'");
foreach ($data as $d) :
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Detail Pelaporan IKO<?= $d['id']; ?></h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="card-body">
          <form action="" method="POST">
            <div class="col-md-12">
              ...
              <div class="row">
              <div class="col-md-2">
                  <label for="id">No Pelaporan :</label>
                  <input type="text" name="id" id="t=id" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['id']; ?>" readonly>
                </div>
              <div class="col-md-4">
              ...
              <div class="col-md-4">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" name="tp" id="tp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['t_lapor']; ?>" readonly>
                </div>
              </div>
              <div class="row">
            <div class="row">
